...
describe("Encoding", function () {
  ...
  it("should return encoded URL with + instead of %20 according to X_WWW_FORM_URLENCODED", function () {
    ...
    let URL = LisURLEncoder.encode("https://www.google.com/search", [{
      ...
      key: "aqs",
      value: "chrome..69i57j69i60l3j69i65.9413j0j1"
    }, {
      key: "sourceid",
      value: "chrome"
    }, {
    ...
    assert.equal(URL, "https://www.google.com/search?q=lisandro+francesco&oq=lisandro+francesco&aqs=chrome..69i57j69i60l3j69i65.9413j0j1&sourceid=chrome&ie=UTF-8");
  ...
  it("should not convert !'()* with RFC3986 = false", function () {
    ...
    assert.equal(URL, "https://www.google.com/search?q=lisandro%20!'()*%20francesco");
    LisURLEncoder.reset();
  });
});
describe("Decoding", function () {
  it("should return decoded value by URL", function () {
    let result = LisURLEncoder.decode("https://www.google.com/search?q=lisandro+francesco&oq=lisandro+francesco&aqs=chrome..69i57j69i60l3j69i65.9413j0j1&sourceid=chrome&ie=UTF-8");
